...
## Description
가장 기본적인 블록 암호 운영모드로, 각 평문 블록을 독립적으로 암호화합니다.

---

### Encryption
![ECB Mode](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/ECB_encryption.svg/600px-ECB_encryption.svg.png)
### Decryption
...
- Section: 6.1 Electronic Codebook Mode (Page 6)