...
## Description
암호 알고리즘의 출력값을 다시 입력으로 피드백하여 평문과 무관한 키 스트림을 생성합니다.

---

### Encryption
![OFB Mode](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/OFB_encryption.svg/600px-OFB_encryption.svg.png)
### Decryption
...
- Section: 6.4 Output Feedback Mode (Page 12)