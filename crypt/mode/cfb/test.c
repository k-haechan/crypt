...
int main() {
    ...
    printf("--- AES-128 CFB NIST SP 800-38A 테스트 시작 ---\n");

    Cipher_CFB_Encrypt(AES_Encrypt, NIST_PT, cipher, 16, NIST_KEY, 128, NIST_IV);
    ...
    // CFB 복호화는 AES_Encrypt를 사용함
    Cipher_CFB_Decrypt(AES_Encrypt, cipher, decrypted, 16, NIST_KEY, 128, NIST_IV);
